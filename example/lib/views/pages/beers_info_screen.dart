...
class _BeersInfoScreenState extends State<BeersInfoScreen> {
  ...
  Widget get _beetImageAndTitle => (Column(
        children: [
          SizedBox(
  ...
  Widget get _beerDetails => (Container(
  ...
  Widget get _chooseIngredient => (Global.beers.adapter.isOnline
      ? Container(
          height: 50,
  ...
  Widget _ingredientCircle(int i) => (Padding(
  ...
  Widget get _ingredientsData => (Global.beers.adapter.isOnline
      ? Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            Column(
              children: [
                Text("Name: ${ingredients[selectedIndex].name}",
